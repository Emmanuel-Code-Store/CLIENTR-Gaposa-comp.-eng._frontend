  ...
  <>
    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Typography component="h2" sx={{ fontSize: '3rem' }}>About Us</Typography>
      </Box>
    </Box>
    <Box sx={{
      width: '100%', minHeight: '100vh', bgcolor: '#fff', display: 'flex',
      ...
      <Box sx={{
        ...
        <Box textAlign="center">
          <Typography component="h2" sx={{ color: '#FF2600', fontSize: { xs: '.7rem', sm: '1rem', md: '2rem' } }}>COMMITMENT AND VALUES</Typography>
          <Typography component="h2" sx={{ color: '#FF2600', fontSize: { xs: '.7rem', sm: '1rem', md: '2rem' } }}>
            ---------------------------OF -----------------------------</Typography>
          <Typography component="p" sx={{ fontSize: { xs: '1rem', sm: '2rem', md: '3rem' }, lineHeight: { xs: '2rem', sm: '3rem', md: '5.725rem' }, color: ' #572269' }}>COMPUTER ENGINEERING</Typography>
        </Box>
        <Typography component="p" sx={{ fontSize: { sm: '1.25rem', md: '1.25rem' }, lineHeight: '2.5rem', color: '#3A3E47' }}>At Computer Engineering Department, we believe in nurturing a culture where commitment and value converge to shape bright futures. Our unwavering dedication to excellence is evident in every aspect of our educational journey. With a deep-rooted commitment to providing holistic education and instilling enduring values, we pave the way for each child to flourish and succeed. Join us on this transformative path, where every step taken is imbued with purpose and promise.</Typography>
      </Box>
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Typography component="h2" sx={{ fontSize: { xs: '2.75rem', sm: '2.75rem', md: '3.75rem' }, lineHeight: { xs: '3.625rem', sm: '3.625rem', md: '5.625rem' }, color: '#fff', fontWeight: { xs: '20rem', sm: '30rem', md: '50rem' } }}>Our Objectives</Typography>
            <Box sx={{ borderLeft: '1px solid #fff ', padding: '0 1.25rem' }}>
              <Typography component="p">To be an enviable centre of Academic Excellence where each child is nurtured to soar to Greater height in His Steps.</Typography>
            </Box>
          </Box>
          <Box sx={{
            ...
            <Box sx={{ width: { xs: '100%', sm: '100%', md: '100%', lg: '24.79rem' }, borderTop: '1px solid #FFFFFF' }}>
              <Typography component="h3" sx={{ fontSize: { xs: '2.75rem', sm: '2.75rem', md: '3.75rem' }, lineHeight: { xs: '3.625rem', sm: '3.625rem', md: '5.625rem' }, color: '#fff', fontWeight: { xs: '20rem', sm: '30rem', md: '50rem' } }}>Our Vision</Typography>
              <Typography component="p">To be an enviable centre of Academic Excellence where each child is nurtured to soar to Greater height in His Steps.</Typography>
            </Box>

            <Box sx={{ width: { xs: '100%', sm: '100%', md: '100%', lg: '24.79rem' }, borderTop: '1px solid #FFFFFF' }}>
              <Typography component="h3" sx={{ fontSize: { xs: '2.75rem', sm: '2.75rem', md: '3.75rem' }, lineHeight: { xs: '3.625rem', sm: '3.625rem', md: '5.625rem' }, color: '#fff', fontWeight: { xs: '20rem', sm: '30rem', md: '50rem' } }}>Our Mission</Typography>
              <Typography component="p">To provide a world class learning opportunities where no child is left out or behind.</Typography>
            </Box>

            <Box sx={{ width: { xs: '100%', sm: '100%', md: '100%', lg: '24.79rem' }, borderTop: '1px solid #FFFFFF' }}>
              <Typography component="h3" sx={{ fontSize: { xs: '2.75rem', sm: '2.75rem', md: '3.75rem' }, lineHeight: { xs: '3.625rem', sm: '3.625rem', md: '5.625rem' }, color: '#fff', fontWeight: { xs: '20rem', sm: '30rem', md: '50rem' } }}>Our Core Values</Typography>
              <Typography component="p">An Academic Excellence Center: Nurturing Every Child&quot;s Potential to Soar.</Typography>
            </Box>
          </Box>
        </Box>
      </Box>
    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Box sx={{ bgcolor: '#F3E9F7', width: '100%', height: '4.25rem' }}>
          <Typography component="p" sx={{ fontWeight: { xs: '11.25rem', sm: '21.25rem', md: '31.25rem' }, lineHeight: '4rem', paddingLeft: '1.25rem', fontSize: { xs: '.9rem', sm: '1rem', md: '2rem' } }}>Computer Engineering Department ANTHEM</Typography>
        </Box>
        ...
        <Link href="/schoolmanagement">
          <Button sx={{ width: '100%',  borderRadius: '30px', border: '1px solid #0C123A', bgcolor: '#659AC9', color: '#fff', display: 'flex', flexDirection: 'row', gap: '1rem', height: '3.75rem', }}>
