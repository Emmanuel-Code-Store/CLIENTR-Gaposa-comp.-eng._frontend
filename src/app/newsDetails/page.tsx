...
const Newsdetails: React.FC = () => (
  <>
    ...
    <Box sx={{
      ...
      <Typography component="h2" sx={{ fontSize: { xs: '1.75rem', sm: '2.75rem', md: '3.75rem' }, lineHeight: { xs: '2.625rem', sm: '3.625rem', md: '5.625rem' }, fontFamily: 'Raleway, sans-serif' }}>Section 1.10.32 of &quot;de Finibus Bonorum et Malorum&quot;, written by Cicero in 45 BC</Typography>
      ...
      <Box>
        <Typography component="p" sx={{fontSize:'1.5rem', lineHeight:'3rem', fontFamily: 'Raleway, sans-serif'}}>
