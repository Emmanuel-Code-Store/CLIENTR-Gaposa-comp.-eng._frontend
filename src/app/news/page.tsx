  ...
  <>
    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Typography component="h2" sx={{ fontSize: '3rem' }}>News Letter</Typography>
        <Typography component="p" textAlign="center" sx={{ fontSize: { xs: '.9rem', sm: '1rem', md: '1.5rem' }, padding: '0 2rem' }}>Stay Connected with Tender Steps School: Get the Latest Updates and News</Typography>
      </Box>
    </Box>
    <Box sx={{
      ...
      <Link href="/newsDetails">
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Typography component="p" sx={{ color: '#FF2600', fontSize: '2.25rem' }}>Important</Typography>
