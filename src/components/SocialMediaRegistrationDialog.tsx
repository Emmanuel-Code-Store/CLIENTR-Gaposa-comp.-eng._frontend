...
interface SocialMediaRegistrationDialogProps {
  open: boolean;
  onClose: () => void;
}

const SocialMediaRegistrationDialog: FC<SocialMediaRegistrationDialogProps> = ({ open, onClose }) => {
...
export default SocialMediaRegistrationDialog;
