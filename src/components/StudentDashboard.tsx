...
const studentMyTasks = [
  ...
  },
  {
    ...
    taskName: "Debate Preparation",
    submissionDate: "April 29, 2024",
    status: "Graded",
  },
];

const studentElectionOptions = [
  {
    id: 1,
...
const studentMyMessages = [
  ...
  },
  {
    ...
    avatar: "/placeholder.svg?height=40&width=40",
    time: "2 days ago",
    message: "Election voting opens soon",
  },
];
...
const studentMyActivities = [
  {
    ...
    type: "Task Assigned",
    icon: "assignment",
    message: "New essay task on WWII",
    time: "3 hours ago",
  },
  {
    id: 2,
    type: "Election Open",
    icon: "vote",
    message: "Voting for Student Council is now open",
    time: "1 day ago",
  },
  {
    id: 3,
    type: "Grade Received",
    icon: "grade",
    message: "Received grade for History 101",
    time: "2 days ago",
  },
];

export function StudentDashboard({ user, roleName }: DashboardProps) {
                ...
                <Table sx={{ minWidth: 650 }}>
                  <TableHead sx={{ backgroundColor: "#f5f5f5" }}>
                    <TableRow>
                      ...
                      <TableCell>Task/Candidates</TableCell>
                      <TableCell>Date</TableCell>
                      <TableCell>Status/Action</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {studentMyTasks.map((task) => (
                    ...
                    {studentElectionOptions.map((election) => (
            ...
            <Grid item xs={12} md={4}>
              <Card sx={{ mb: 3, boxShadow: "none", border: "1px solid #e0e0e0" }}>
                <CardContent>
                  ...
                  <List sx={{ p: 0 }}>
                    {studentMyMessages.map((message, index) => (
                      <Box key={message.id}>
                        ...
                        {index < studentMyMessages.length - 1 && <Divider variant="inset" component="li" />}
                      </Box>
                    ))}
                  </List>
                </CardContent>
              ...
              <Card sx={{ boxShadow: "none", border: "1px solid #e0e0e0" }}>
                <CardContent>
                  ...
                  <List sx={{ p: 0 }}>
                    {studentMyActivities.map((activity, index) => (
                      <Box key={activity.id}>
                        <ListItem alignItems="flex-start" sx={{ px: 0 }}>
                          <ListItemAvatar>
                            <Avatar
                              sx={{
                                bgcolor:
                                  activity.icon === "assignment" ? "#2196f3" : activity.icon === "vote" ? "#ff9800" : "#4caf50",
                              }}
                            >
                              <NotificationIcon />
                            </Avatar>
                        ...
                        {index < studentMyActivities.length - 1 && <Divider variant="inset" component="li" />}
                      </Box>
                    ))}
                  </List>
                </CardContent>
                  ...
                  <Box sx={{ p: 3 }}>
                    ...
                    <Stack spacing={2}>
                      <Select fullWidth size="small" displayEmpty value="">
                        ...
                        <MenuItem value="wwii">WWII Essay</MenuItem>
                        <MenuItem value="coldwar">Cold War Research</MenuItem>
                      </Select>
                      <Box>
                  ...
                  <Box sx={{ p: 3 }}>
                    ...
                    <Stack spacing={2}>
                      <Select fullWidth size="small" displayEmpty value="">
                        ...
                        <MenuItem value="president">Student President</MenuItem>
