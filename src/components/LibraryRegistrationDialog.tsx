...
interface LibraryRegistrationDialogProps {
  open: boolean;
  onClose: () => void;
}

const LibraryRegistrationDialog: FC<LibraryRegistrationDialogProps> = ({ open, onClose }) => {
...
export default LibraryRegistrationDialog;
