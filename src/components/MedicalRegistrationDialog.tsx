...
interface MedicalRegistrationDialogProps {
  open: boolean;
  onClose: () => void;
}

const MedicalRegistrationDialog: FC<MedicalRegistrationDialogProps> = ({ open, onClose }) => {
...
export default MedicalRegistrationDialog;
