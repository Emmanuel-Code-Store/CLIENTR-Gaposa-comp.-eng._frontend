...
interface StatusRegistrationDialogProps {
  open: boolean;
  onClose: () => void;
}

const StatusRegistrationDialog: FC<StatusRegistrationDialogProps> = ({ open, onClose }) => {
...
export default StatusRegistrationDialog;